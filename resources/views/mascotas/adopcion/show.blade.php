...
@section('title', $mascota->nombre . ' - En Adopción')
...
<div class="min-h-screen bg-gradient-to-br from-pink-50 to-purple-50 py-8">
    ...
    <!-- Botón Volver Atrás -->
        <div class="mb-6">
            <a href="{{ url()->previous() }}" 
               class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 transition-all duration-200">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                    <div class="bg-gradient-to-r from-pink-600 to-purple-700 px-6 py-4">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-4">
                                <div class="flex items-center p-3 bg-pink-50 rounded-lg">
                                    <i class="fas fa-paw text-pink-600 text-lg w-6"></i>
                                    <div class="ml-3">
                                ...
                                <div class="flex items-center p-3 bg-pink-50 rounded-lg">
                                    <i class="fas fa-dna text-pink-600 text-lg w-6"></i>
                                    <div class="ml-3">
                                ...
                                <div class="flex items-center p-3 bg-pink-50 rounded-lg">
                                    <i class="fas fa-birthday-cake text-pink-600 text-lg w-6"></i>
                                    <div class="ml-3">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center p-3 bg-pink-50 rounded-lg">
                                    <i class="fas fa-venus-mars text-pink-600 text-lg w-6"></i>
                                    <div class="ml-3">
                                ...
                                <div class="flex items-center p-3 bg-pink-50 rounded-lg">
                                    <i class="fas fa-palette text-pink-600 text-lg w-6"></i>
                                    <div class="ml-3">
                                ...
                                <div class="flex items-center p-3 bg-pink-50 rounded-lg">
                                    <i class="fas fa-ruler text-pink-600 text-lg w-6"></i>
                                    <div class="ml-3">
                        ...
                        <div class="mt-6">
                            <div class="flex items-center p-3 bg-pink-50 rounded-lg">
                                <i class="fas fa-map-marker-alt text-pink-600 text-lg w-6"></i>
                                <div class="ml-3">
                        ...
                        <div class="mt-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-3 flex items-center">
                                <i class="fas fa-align-left text-pink-600 mr-2"></i>
                                Descripción
                            </h3>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                    <div class="bg-gradient-to-r from-purple-600 to-purple-700 px-6 py-4">
                        <h2 class="text-xl font-bold text-white flex items-center">
                            ...
                            Ayuda a {{ $mascota->nombre }} a encontrar una familia
                        </h2>
                    </div>
                    <div class="p-6">
                        <p class="text-gray-700 mb-6 text-center">
                            Comparte esta publicación para ayudar a {{ $mascota->nombre }} a encontrar un hogar permanente
                        </p>
                        
                        <!-- Botones de redes sociales solo con iconos -->
                        <div class="flex justify-center space-x-6">
                            <!-- Facebook -->
                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}&quote={{ $mascota->nombre }} busca familia. ¿Puedes darle un hogar?"
                               target="_blank" 
                               rel="noopener"
                            ...
                            <!-- WhatsApp -->
                            <a href="https://wa.me/?text={{ $mascota->nombre }} busca familia. ¿Puedes darle un hogar? - {{ urlencode(url()->current()) }}"
                               target="_blank"
                               rel="noopener"
                            ...
                            <!-- Telegram -->
                            <a href="https://t.me/share/url?url={{ urlencode(url()->current()) }}&text={{ $mascota->nombre }} busca familia. ¿Puedes darle un hogar?"
                               target="_blank"
                               rel="noopener"
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                    <div class="p-6">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-gray-600 mt-2">En adopción desde {{ $mascota->created_at->format('d/m/Y') }}</p>
                            <div class="mt-3 inline-flex items-center px-3 py-1 bg-pink-100 text-pink-800 rounded-full text-sm font-medium">
                                <i class="fas fa-heart mr-1"></i>
                                Busca familia hace {{ $mascota->created_at->diffForHumans() }}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="text-center">
                        @if(Auth::check() && Auth::id() === $mascota->user_id)
                            <div class="bg-pink-50 border border-pink-200 rounded-xl p-4">
                                <i class="fas fa-info-circle text-pink-600 text-xl mb-2"></i>
                                <p class="text-pink-800 font-medium">Esta mascota está en adopción por ti</p>
                                <p class="text-pink-600 text-sm mt-1">Esperamos que encuentre una buena familia</p>
                                
                                <!-- Botón para ver conversaciones sobre esta mascota -->
                                <a href="{{ route('contactar.index') }}" 
                                   class="inline-flex items-center px-4 py-2 bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition-colors mt-3 text-sm">
                        ...
                        @else
                            ...
                            @auth
                                ...
                                <a href="{{ route('contactar.create', $mascota) }}" 
                                   class="w-full bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center text-lg">
                            ...
                            @else
                                ...
                                <p class="text-sm text-gray-600 mt-3">
                                    ¿Estás listo para darle un hogar?
                                </p>
                            @endauth
