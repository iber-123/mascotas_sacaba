...
<head>
    ...
    <title>Editar {{ $mascota->nombre }} - Mascotas Sacaba</title>
...
<body class="bg-gradient-to-br from-green-50 to-blue-50 min-h-screen font-sans">
        ...
        <div class="max-w-6xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-gray-800">Editar Mascota</h1>
                        <p class="text-gray-600 text-sm">Actualiza la información de {{ $mascota->nombre }}</p>
                    </div>
                </div>
    ...
    <main class="max-w-4xl mx-auto px-4 py-8">
        ...
        <!-- Formulario -->
        <form action="{{ route('user.mascotas.update', $mascota) }}" method="POST" enctype="multipart/form-data" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nombre" id="nombre" 
                               ...
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl input-focus transition-all @error('nombre') error-border @enderror"
                    ...
                    <div>
                        ...
                        <select name="especie" id="especie" 
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl input-focus transition-all @error('especie') error-border @enderror" required>
                    ...
                    <div>
                        ...
                        <select name="estado" id="estado" 
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl input-focus transition-all @error('estado') error-border @enderror" required>
                            <option value="">¿Qué pasó con la mascota?</option>
                            <option value="perdida" {{ old('estado', $mascota->estado) == 'perdida' ? 'selected' : '' }}>🔍 Se perdió</option>
                            <option value="encontrada" {{ old('estado', $mascota->estado) == 'encontrada' ? 'selected' : '' }}>🏠 La encontré</option>
                            <option value="adopcion" {{ old('estado', $mascota->estado) == 'adopcion' ? 'selected' : '' }}>💖 En adopción</option>
                        </select>
                        @error('estado')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="raza" id="raza" 
                               ...
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl input-focus transition-all @error('raza') error-border @enderror"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="edad" id="edad" 
                               ...
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl input-focus transition-all @error('edad') error-border @enderror"
                    ...
                    <div>
                        ...
                        <select name="sexo" id="sexo" 
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl input-focus transition-all @error('sexo') error-border @enderror">
                    ...
                    <div>
                        ...
                        <select name="tamaño" id="tamaño" 
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl input-focus transition-all @error('tamaño') error-border @enderror">
                            <option value="">Selecciona</option>
                    ...
                    <div>
                        ...
                        <input type="text" name="color" id="color" 
                               ...
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl input-focus transition-all @error('color') error-border @enderror"
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="ubicacion" id="ubicacion" 
                               value="{{ old('ubicacion', $mascota->ubicacion) }}"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl input-focus transition-all @error('ubicacion') error-border @enderror"
                    ...
                    <div>
                        ...
                        <input type="file" name="foto" id="foto" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl input-focus transition-all @error('foto') error-border @enderror"
                               accept="image/*">
                        ...
                        <div id="imagePreview" class="mt-3 hidden">
                            ...
                            <img id="preview" src="#" alt="Vista previa" class="current-image">
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea name="descripcion" id="descripcion" rows="4"
                              class="w-full px-4 py-3 border border-gray-300 rounded-xl input-focus transition-all @error('descripcion') error-border @enderror"
                              placeholder="Describe características únicas, comportamiento, collar, etc...">{{ old('descripcion', $mascota->descripcion) }}</textarea>
