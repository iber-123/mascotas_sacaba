...
@section('title', 'Editar ' . $mascota->nombre . ' - Admin')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h1 class="text-primary">
                <i class="fas fa-edit mr-2"></i>Editar Mascota: {{ $mascota->nombre }}
            </h1>
            <p class="text-muted mb-0">Actualiza la información de la mascota</p>
        </div>
        <div>
            <a href="{{ route('admin.mascotas.show', $mascota) }}" class="btn btn-info mr-2">
        ...
        <div class="col-md-8 mx-auto">
            <div class="card card-outline card-warning">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-paw mr-2"></i>Editar Información
                    </h3>
                </div>
                <form action="{{ route('admin.mascotas.update', $mascota) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="estado" id="estado" 
                                        ...
                                        <option value="perdida" {{ old('estado', $mascota->estado) == 'perdida' ? 'selected' : '' }}>Perdida</option>
                                        <option value="encontrada" {{ old('estado', $mascota->estado) == 'encontrada' ? 'selected' : '' }}>Encontrada</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="descripcion" id="descripcion" 
                                      ...
                                      rows="4" 
                                      placeholder="Describe características especiales, comportamiento, etc.">{{ old('descripcion', $mascota->descripcion) }}</textarea>
                            @error('descripcion')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="text-center">
                                ...
                                <div class="mt-2">
                                    <small class="text-muted">Foto actual de {{ $mascota->nombre }}</small>
                                </div>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" name="foto" id="foto" 
                                       ...
                                       accept="image/*">
                                <label class="custom-file-label" for="foto">Seleccionar nueva foto...</label>
                                @error('foto')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <small class="form-text text-muted">
                                Deja vacío para mantener la foto actual. Formatos: JPEG, PNG, JPG, GIF. Tamaño máximo: 2MB
                            </small>
                        </div>
                        ...
                        <div class="form-group text-center" id="image-preview" style="display: none;">
                            ...
                            <img id="preview" src="#" alt="Vista previa" class="img-fluid rounded shadow-sm mt-2" style="max-height: 200px;">
                        </div>
                    </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('admin.mascotas.show', $mascota) }}" class="btn btn-info btn-lg">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        fotoInput.addEventListener('change', function() {
            const fileName = this.files[0] ? this.files[0].name : 'Seleccionar nueva foto...';
