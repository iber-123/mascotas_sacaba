...
<head>
    ...
    <title>Crear Cuenta - Mascotas Sacaba</title>
    ...
    <header class="header-container">
        <div class="header-content">
            ...
            <div class="flex items-center space-x-2">
                <a href="{{ route('login') }}" class="login-nav-link font-semibold text-gray-600">Iniciar sesión</a>
                <a href="{{ route('register') }}" class="register-nav-btn bg-green-500 text-white px-4 py-2 rounded-lg font-medium active">Registrarse</a>
            </div>
        </div>
    </header>
